...
export const WIKI_TOPICS: WikiTopic[] = [
  // ==================== 1. 术后病理密码破译 (按风险高低排序) ====================
  {
    ...
    keyMetric: {
      label: "亚肺叶切除复发风险比",
      value: "HR = 1.87 (肺叶切除可最大化控制)",
      source: "Kadota et al., JTO / Annals of Surgery",
    },
    faq: [
      {
  ...
  },
  {
    ...
    tactics: [
      ...
      "术后定期复查胸部增强薄层 CT，重点监测胸膜腔、叶间裂与纵隔淋巴结区域",
    ],
  ...
  },
  {
    ...
    clinicalTruth: "PL3 是指肿瘤直接穿透胸膜腔侵犯至壁层胸膜或胸壁组织（如肋骨、肋间肌）。依据 AJCC 第 8/9 版分期标准，无论肿瘤原本多小，一旦出现 PL3，T 分期直接定为 T3 期（若 N0 为 IIB 期，若 N1 为 IIIA 期，若 N2 为 IIIB 期）。外科标准治疗原则为整块切除（En-bloc 切除），保证切缘病理阴性（R0），术后依据病理及驱动基因状态常规行辅助靶向/化疗/放疗。",
    tactics: [
  ...
  },
  {
    ...
    tactics: [
      ...
      "对于 IB 期合并 LVI 或 II-IIIA 期患者，积极讨论术后辅助靶向（奥希替尼等）或含铂双药化疗",
  ...
  },
  {
    ...
    tactics: [
      ...
      "术后必须接受规范系统辅助治疗：EGFR 突变阳性首选奥希替尼辅助靶向治疗（3年）；突变阴性首选含铂双药辅助化疗 ± 免疫辅助治疗",
  ...
  // ==================== 2. 肺结节消恐与随访 (按风险高低排序) ====================
  {
    ...
    tactics: [
      ...
      "CTR ≤ 0.5 的早期结节即使需手术干预，指南首选解剖性肺段切除（Segmentectomy）或楔形切除，最大程度保留健康肺功能",
      "依据 JCOG0804/JCOG0802 国际顶级多中心随机对照研究，CTR ≤ 0.5 亚肺叶切除后 5 年无复发生存率高达 99.7%",
    ],
