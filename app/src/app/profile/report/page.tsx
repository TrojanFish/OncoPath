...
export default function EvidenceReportPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/70 pb-8 sm:pb-12 print:bg-white print:pb-0 text-slate-900">
      ...
      {/* Global Unified Floating Navbar */}
      <SubpageNavbar />

      {/* Main Page Layout Wrapper */}
      <main className="max-w-5xl mx-auto px-2.5 sm:px-6 lg:px-8 pt-24 sm:pt-28 pb-16 print:pt-0 print:px-0">
        ...
        <div id="report-printable-area" ref={reportContainerRef} className="space-y-4 sm:space-y-5 bg-slate-50/90 p-3.5 sm:p-6 md:p-7 rounded-3xl border border-slate-200/90 shadow-sm print:bg-white print:border-none print:shadow-none print:p-0">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3.5 border-b border-slate-200/90 text-xs text-slate-500">
            ...
            <div className="flex items-center gap-2 flex-wrap self-end sm:self-auto shrink-0 print:hidden">
              {/* PDF Export Button */}
              {!isGenerating && (
                <button 
                  onClick={handleDirectPdfExport}
                  disabled={isExportingDirectPdf}
                  className="flex items-center gap-1.5 px-3 py-1 rounded-xl text-[11px] font-bold bg-white hover:bg-slate-50 text-slate-700 hover:text-blue-700 border border-slate-200 hover:border-blue-300 transition-all shadow-2xs cursor-pointer group whitespace-nowrap disabled:opacity-50"
                  title="一键直接下载 A4 PDF 文档"
                >
              ...
              <Link
                href="/profile"
                className="inline-flex items-center gap-1 text-[11px] font-bold text-slate-700 hover:text-blue-700 bg-white hover:bg-slate-50 px-2.5 py-1 rounded-xl border border-slate-200 shadow-2xs hover:border-blue-200 transition-all cursor-pointer group"
              ...
              <div className="text-[11px] text-slate-400 font-medium font-mono whitespace-nowrap pl-1">
