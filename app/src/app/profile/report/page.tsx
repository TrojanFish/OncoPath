      ...
      <div className="fixed top-4 left-0 right-0 z-50 px-4 sm:px-6 pointer-events-none print:hidden">
        <nav className="max-w-5xl mx-auto flex items-center justify-between px-5 sm:px-7 py-3 rounded-2xl sm:rounded-full bg-white/90 backdrop-blur-md border border-slate-200/80 shadow-lg shadow-slate-900/5 transition-all pointer-events-auto">
          <div className="flex items-center gap-3">
            <Link 
              href="/profile" 
              className="text-xs sm:text-sm font-semibold text-slate-600 hover:text-accent-blue transition-colors px-2.5 py-1.5 rounded-xl hover:bg-slate-100"
            >
              返回档案
            </Link>
            ...
            {!isGenerating && (
              <>
                <button
                  ...
                  className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-semibold text-blue-700 bg-blue-50/80 hover:bg-blue-100 border border-blue-200 transition-all cursor-pointer shadow-2xs group"
                  title="一键提取问诊清单"
                >
