      ...
      <div className="fixed top-2.5 sm:top-4 left-0 right-0 z-50 px-2 sm:px-6 pointer-events-none print:hidden">
        <nav className="max-w-5xl mx-auto flex items-center justify-between px-2.5 sm:px-6 py-2 sm:py-2.5 rounded-2xl sm:rounded-full bg-white/95 backdrop-blur-md border border-slate-200/90 shadow-lg shadow-slate-900/5 transition-all pointer-events-auto gap-2">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            <Link 
              href="/profile" 
              className="text-xs sm:text-sm font-bold text-slate-600 hover:text-accent-blue transition-colors px-2 py-1 sm:px-2.5 sm:py-1.5 rounded-xl hover:bg-slate-100 whitespace-nowrap flex-shrink-0"
            >
            ...
            {!isGenerating && (
              <>
                <button
                  ...
                  className="flex items-center gap-1 sm:gap-1.5 px-2.5 py-1.5 sm:px-3.5 sm:py-1.5 rounded-xl text-xs font-bold text-blue-700 bg-blue-50/90 hover:bg-blue-100 border border-blue-200 transition-all cursor-pointer shadow-2xs group whitespace-nowrap"
                  title="一键提取问诊清单"
                >
                  <svg className="w-3.5 h-3.5 text-blue-600 transition-transform group-hover:scale-110 flex-shrink-0" viewBox="0 0 24 24" fill="none">
                ...
                >
                  <svg className="w-3.5 h-3.5 transition-transform group-hover:-translate-y-0.5 flex-shrink-0" viewBox="0 0 24 24" fill="none">
