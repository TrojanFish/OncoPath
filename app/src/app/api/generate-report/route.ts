...
5. 【极早期 IA 期（IA1/IA2）无高危患者的随访策略与过度医疗防线】：
   - 若患者为 **IA1 / IA2 期（T1a/T1b N0 M0）且无高危病理因素（STAS阴性、VPI阴性、LVI阴性、R0切除）**：
     - 必须明确告知患者：**根据 NCCN、CSCO 与 ESMO 国际权威指南，IA 期手术完全切除后 5 年生存率高达 98%~100%，已达临床根治标准；全球所有指南一致公认【无需任何术后辅助化疗、靶向药物或免疫治疗，常规不推荐为了指导术后辅助用药而做驱动基因检测】**。医院病理科会将手术切片与蜡块妥善封存 10~20 年备用。
     - **核心行动指引**：遵从规律随访时间表（每 6~12 个月复查胸部薄层 HRCT），无需盲目过度检测或吃药，把心放宽回归正常工作与生活！
6. 【中高危患者（IB 期伴高危因素、II 期、III 期）的精准靶向指导】：
   - 若患者处于 IB 期合并高危因素（如实性成分高、VPI+、STAS+）或 II~IIIA 期，应建议完善驱动基因检测（EGFR/ALK 等），以指导是否启动 ADAURA（奥希替尼）或 ALINA（阿来替尼）等术后辅助靶向治疗（降低 70%~83% 复发风险）。
...
- **组织学分级 (IASLC Grade)** 与 **分子驱动基因突变谱 (EGFR/ALK/KRAS/伴随共突变 TP53 等)**：
  - 若为 IA 期无高危患者，重点解释“虽检出敏感突变，但 IA 期手术已实现根治，国际指南严禁盲目服用靶向药辅助治疗，避免过度医疗与耐药风险”的共识；
  - 若为 IB 高危/II/III 期患者，重点分析靶向治疗契机（引用 ADAURA 研究奥希替尼辅助靶向降低复发风险 70%~83%，或 ALINA 研究阿来替尼）；
  - 若患者检出 **TP53 伴随共突变 (Co-mutation)**，客观科学向患者解释：TP53 突变在肺腺癌中发生率高达 30%~50%，提示细胞增殖代谢稍活跃，关键应对措施为在术后前 2 年遵医嘱每 3~6 个月规律复查薄层 CT，无需惊慌；
  - 若包含 **PD-L1 表达 (TPS)**，说明其在后续免疫治疗储备方案中的指导价值。

## 3. 📋【门诊就医问诊便签卡（向主治医生当面请教的问题）】
...
## 5. ❤️【写在最后：专家组定心丸与长程守护】
在报告正文最末尾，请务必完整输出以下温情定心丸寄语与团队署名（绝不要使用“某某医生”等单个姓名占位符）：
您的肺部肿瘤已在极早期获得根治，请您放下所有的心理包袱，勇敢而乐观地迎接新生活。医学的进步正在不断延长和改善着患者的生命质量，而您正处于这股进步浪潮中最受益的群体之一。

祝您早日康复，健康平安！

**OncoPath 胸部肿瘤多学科诊疗 (MDT) 专家组与循证医学团队** 敬上
...
请根据该患者的【胸部 CT 影像学诊断档案】（包括主结节部位、大小、CT实性成分CTR、恶性影像征象毛刺/分叶/胸膜牵拉/空泡征等）、【多发结节与伴随微小病灶状态】、【历史多次随访生长轨迹 (VDT)】、【血液肿瘤标志物 (CEA/CYFRA21-1等)】、【全身排查状态 (脑MRI/腹部超声/骨扫描)】与【系统检索到的前瞻性临床研究证据（Fleischner指南 / JCOG0804 / JCOG0802等）】，为患者生成一份极具专业权威性、温情同理心、排版清晰优雅的《肺结节深度影像循证与良恶性决策报告》。

请严格按照以下 5 大核心板块输出（请使用标准 Markdown 格式）：

> 💡 **【核心执行摘要 · Executive Summary】**
> - **影像诊断与恶性风险评估**：客观说明主病灶形态（纯磨玻璃/部分实性/实性）与良恶性风险评级（低危/中危/高危）。
> - **长程生长轨迹与倍增速度研判**：若档案包含多次随访记录，客观说明前后对比体积倍增时间（VDT）是处于“稳定期”、“慢速惰性期”还是“活跃进展期”。
> - **双肺多发结节与伴随微小灶定性**：若患者为多发结节，明确向患者科普“双肺多发微小结节极其常见，多为陈旧良性病灶，绝不等于转移扩散”。
> - **血液肿瘤标志物简析**：若患者提供了 CEA 等指标，客观说明其处于正常区间（正常范围内的波动属于生理性起伏）或轻度偏高的良性原因。
...
- **主结节解剖与大小拆解**：解读主病灶所在肺叶肺段，分析大体总径与 CT 实性浸润成分（CTR）的关键意义。
- **恶性影像征象通俗拆解**：逐一通俗解释报告中检出的分叶征、毛刺征、胸膜牵拉征、空泡征、血管集束征等生物学发生机制与临床真实含义。
- **多发结节与伴随微小病灶良性排雷**：若存在次要伴随结节，明确区分“主病灶”与“次要良性微小结节”，消除多发性转移恐慌。
- **伴发良性病变排雷说明**：对患者伴发的肝囊肿、肺内钙化灶、甲状腺结节等常见良性表现予以明确澄清，打消转移恐慌。
...
- **长程随访演变趋势与倍增时间 (VDT)**：结合历史 CT 演变，给出定量生长速度评估。

## 3. 📋【向胸外科/呼吸科医生的门诊问诊清单（就医便签）】
请使用复选框清单格式 \`- [ ] **【关注点】**：具体问询问题\` 呈现 3-4 个高价值问题：
- [ ] **【动态变化评估】**：对比以往体检/历史 CT，该主结节的大小、密度或实性成分是否有明显增大？倍增速度如何？
- [ ] **【多发微小结节随访策略】**：除主病灶外，双肺伴随的其他微小结节是否属于良性随访范围？
...
## 5. ❤️【写在最后：专家组定心丸与长程守护】
在报告正文最末尾，请务必完整输出以下温情定心丸寄语与团队署名（绝不要使用“某某医生”等单个姓名占位符）：
肺部磨玻璃结节普遍具有长期惰性生长的生物学特性，绝大多数处于良性或极早期阶段。只要我们遵循现代循证医学指南规范随访，就能牢牢掌握主动权，化恐慌为从容。
...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Multiple Nodules Evidence
    if (profile.isMultipleNodules || (Array.isArray(profile.secondaryNodules) && profile.secondaryNodules.length > 0)) {
      evidenceItems.push("【中华医学会呼吸病学分会 / Fleischner 多发肺结节专家共识】：双肺多发微小结节在成年人体检中检出率高达 30%~45%，绝大多数为既往隐匿性感染遗留的陈旧性纤维化、微小淋巴结或良性肉芽肿。临床应以【主病灶（最大/最可疑结节）】作为干预决策依据，次要微小病灶以常规低剂量薄层 CT 随访即可，绝非恶性转移播散。");
    }

    // Tumor Markers Evidence
    if (profile.tumorMarkers && (profile.tumorMarkers.cea != null || profile.tumorMarkers.cyfra211 != null || profile.tumorMarkers.nse != null)) {
      evidenceItems.push("【CSCO / NACB 肺癌肿瘤标志物临床应用指南】：血液肿瘤标志物（如 CEA、CYFRA21-1）在早期肺癌（尤其是纯磨玻璃及早期微浸润腺癌）中绝大多数呈阴性；在正常参考区间（CEA < 5.0 ng/mL）内的任何数值波动均属生理性正常代谢。轻度偏高常与吸烟、轻微胃肠炎或良性气道炎症相关，临床诊断与随访必须严格以胸部薄层 CT 高分辨影像为金标准。");
    }
