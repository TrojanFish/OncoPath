      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 md:p-12 shadow-sm border border-slate-200 space-y-10">
          ...
          <div className="space-y-8 text-sm sm:text-base leading-relaxed text-slate-700">
            ...
            {/* Section 1: Core Disclaimer (Special Alert Box) */}
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-slate-900 flex items-center gap-2.5">
                <span className="w-7 h-7 rounded-xl bg-amber-50 border border-amber-200 text-amber-800 flex items-center justify-center text-xs font-black shrink-0">1</span>
                <span>核心医疗免责声明与监管合规界限（首要条款）</span>
              </h2>
              <div className="bg-amber-50/80 p-4 sm:p-5 rounded-2xl border border-amber-200/80 space-y-3 text-xs sm:text-sm text-amber-950">
                <p>
            ...
            <section className="space-y-3">
              ...
              <p>
                本平台的所有界面设计、4D知识图谱交互体系、微创解剖手绘图解、3D 决策矩阵算法及专属问诊卡排版布局，其知识产权均归 OncoPath 开发团队所有。用户可免费下载个人就医便签卡供个人就诊或向医生展示使用，未经书面许可不得用于任何商业化转售或爬虫逆向工程。
              </p>
            </section>
